      ...
      <div class="mx-auto w-full max-w-sm lg:w-96">
        ...
        <div>
          ...
          <p class="mt-2 text-sm leading-6 text-gray-500">
            Pas encore inscrit ?
            <NuxtLink to="/inscription" class="font-semibold text-violet-600 hover:text-violet-500">Rejoignez Arvy dès
              maintenant</NuxtLink>
          </p>
        </div>
        ...
        <div class="mt-10">
          <div>
            <form class="space-y-6">
              <div>
                ...
                <div class="mt-2">
                  <input v-model="login" id="email" name="email" type="email" autocomplete="email" required
              ...
              <div>
                <Button @click="clickAuth" class="w-full" color="violet" name="Connexion" />
              </div>
            </form>
          </div>
          ...
          <div class="mt-10">
            ...
            <div class="mt-6 grid grid-cols-2 gap-4">
              <a href="#"
                class="flex w-full items-center justify-center gap-3 rounded-md px-3 py-1.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1D9BF0] border">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 256 315">
                  <path
              ...
              <a href="#"
                class="flex w-full items-center justify-center gap-3 rounded-md px-3 py-1.5 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#24292F] border">
